...
export const LearnerScreen: React.FC<LearnerScreenProps> = ({
  ...
  const handleSubmit = () => {
    ...
    const submissionData: Omit<Submission, 'id'> = {
      ...
      assignedTutorId: matchedLearner?.assignedTutorId,
      assignedTutorUsername: matchedLearner?.assignedTutorUsername,
      assignedTutorName: matchedLearner?.assignedTutorName,
